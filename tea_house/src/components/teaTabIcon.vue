<template>
  <div class="car_icon">
    <van-tabs
      line-height="0"
      style="border: 1px solid #000; height: 100px; display: flex; align-items: center"
    >
      <van-tab style="height: 100px" v-for="item in caricon" :key="item">
        <template #title>
          <div>
    ...
    return {
      caricon: [
        ...
        },
        {
          ...
          title: "吉利汽车",
          icon:
            "https://assets.puercn.com/v3assets/v2/nav-pingce-7f5a7218c2567352d75be7d73ee0844ec70a87214e62043e89be2e48bdc422c1.png",
        },
        {
          id: "",
          title: "茶窝网",
          icon:
            "https://assets.puercn.com/v3assets/v2/nav-chawo-0949aa3491dac7053a49fabeefbc41cca8cc2cabc13d5fb51f56a0b4a4af7ceb.png",
        },
        {
          id: "",
          title: "茶窝网",
